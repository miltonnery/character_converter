...
import (
	...
	viperConfiguration "miltonnery/character_converter/configuration/viper"
	errorHandling "miltonnery/character_converter/error"
	logJSON "miltonnery/character_converter/log/json"
	"miltonnery/character_converter/service"
	"net/http"
	"os"
	"os/signal"
	"syscall"
